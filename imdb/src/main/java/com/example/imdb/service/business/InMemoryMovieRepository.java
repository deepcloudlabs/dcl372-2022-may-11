...
public class InMemoryMovieRepository implements MovieRepository {
	...
	public InMemoryMovieRepository(SequenceService sequenceSrv) {
	...
	@PreDestroy // only for Singleton
	public void shutdown() {
		System.err.println("Shutting down the component...");
	}
	
	@PostConstruct // LifeCycle Callback Annotation
